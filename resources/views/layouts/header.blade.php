                  ...
                  <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user-menu">
                              <button class="dropdown-toggle nav-link ec-drop" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                    <img src="assets/img/user/user.png" class="user-image" alt=" {{ ucwords(Auth::User()->name) }}" />
                              </button>
                              <ul class="dropdown-menu dropdown-menu-right ec-dropdown-menu">
                                    <!--  {{ ucwords(Auth::User()->name) }} -->
                                    <li class="dropdown-header">
                                          <img src="assets/img/user/user.png" class="img-circle" alt=" {{ ucwords(Auth::User()->name) }}" />
                                          <div class="d-inline-block">
                                                {{ ucwords(Auth::User()->name) }} <small class="pt-1">{{
                                                      ucwords(Auth::User()->email) }}</small>
                                          </div>
                                    </li>
                                    <li>
                                    ...
                                    <li class="dropdown-footer">
                                          ...
                                          <form method="POST" action="{{ route('logout') }}">
                                                ...
                                                <a href="{{ route('logout') }}" onclick="event.preventDefault();
                                                      this.closest('form').submit();"><i class="mdi mdi-logout"></i>
                                                      {{ __('Log Out') }}
                                          </a>
                                          </form>
                                          </a>
                                                                  ...
                                                                  <a href="javscript:void(0)"
                                                                        ...
                                                                        <div
                                                                              ...
                                                                              <div class="message-contents">
                                                                                    ...
                                                                                    <p class="last-msg">Donec mattis
                                                                                          augue a nisl
                                                                                          consequat, nec imperdiet ex
                                                                                          rutrum. Fusce et
                                                                                          vehicula enim. Sed in enim eu
                                                                                          odio vehic.</p>
                                                            ...
                                                            <li>
                                                                  <a href="javscript:void(0)"
                                                                        ...
                                                                        <div
                                                                              class="media-body d-flex justify-content-between">
                                                                              <div class="message-contents">
                                                                                    <h4 class="title">Upcomming event
                                                                                          added</h4>
                                                                  ...
                                                                  <a href="javscript:void(0)"
                                                                        ...
                                                                        <div
                                                                              ...
                                                                              <div class="message-contents">
                                                                                    ...
                                                                                    <p class="last-msg font-size-14">Add
                                                                                          Dany Jones as
                                                                                          your contact consequat nec
                                                                                          imperdiet ex rutrum.
                                                                                          Fusce et vehicula enim. Sed in
                                                                                          enim.</p>
                                                            ...
                                                            <li>
                                                                  <a href="javscript:void(0)"
                                                                        ...
                                                                        <div
                                                                              class="media-body d-flex justify-content-between">
                                                                              <div class="message-contents">
                                                                                    <h4 class="title">Server overloaded
                                                                                    </h4>
                                                                                    <p class="last-msg font-size-14">
                                                                                          Donec mattis augue
                                                                                          a nisl consequat, nec
                                                                                          imperdiet ex rutrum. Fusce
                                                                                          et vehicula enim. Sed in enim
                                                                                          eu odio vehic.</p>
                                                                  ...
                                                                  <a href="javscript:void(0)"
                                                                        ...
                                                                        <div
                                                                              ...
                                                                              <div class="message-contents">
                                                                                    ...
                                                                                    <p class="last-msg font-size-14">Nam
                                                                                          ut nisi erat.
                                                                                          Ut quis tortor varius,
                                                                                          hendrerit arcu quis,
                                                                                          congue nisl. In scelerisque,
                                                                                          sem ut ve.</p>
                                                            ...
                                                            <li>
                                                                  <a href="javscript:void(0)"
                                                                        ...
                                                                        <div
                                                                              class="media-body d-flex justify-content-between">
                                                                              <div class="message-contents">
                                                                                    <h4 class="title">New Sales report
                                                                                    </h4>
                                                                                    <p class="last-msg font-size-14">
                                                                                          Lorem ipsum dolor
                                                                                          sit, amet consectetur
                                                            ...
                                                            <li>
                                                                  <a href="javscript:void(0)"
                                                                        ...
                                                                        <div
                                                                              class="media-body d-flex justify-content-between">
                                                                              <div class="message-contents">
                                                                                    <h4 class="title">New Task complete
                                                                                    </h4>
                                                                                    <p class="last-msg font-size-14">Nam
                                                                                          ut nisi erat.
                                                                                          Ut quis tortor varius,
